<svelte:head>
	<title>Features - Foreum</title>
	<meta
		name="description"
		content="Discover all the powerful features that make Foreum the best forum platform for your community."
	/>
</svelte:head>
...
<section class="bg-muted/30 py-20">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="mb-16 text-center">
			<h2 class="font-heading mb-4 text-4xl font-bold text-foreground">Core Features</h2>
			<p class="text-xl text-muted-foreground">The foundation of a great forum experience</p>
		</div>
		...
		<div class="grid grid-cols-1 gap-12 lg:grid-cols-2">
			<div class="flex gap-6">
				...
				<div>
					<h3 class="font-heading mb-3 text-xl font-semibold text-foreground">Rich Text Editor</h3>
			...
			<div class="flex gap-6">
				...
				<div>
					<h3 class="font-heading mb-3 text-xl font-semibold text-foreground">Advanced Search</h3>
					<p class="mb-4 leading-relaxed text-muted-foreground">
			...
			<div class="flex gap-6">
				...
				<div>
					<h3 class="font-heading mb-3 text-xl font-semibold text-foreground">
...
<section class="bg-background py-20">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="mb-16 text-center">
			<h2 class="font-heading mb-4 text-4xl font-bold text-foreground">Moderation & Safety</h2>
			<p class="text-xl text-muted-foreground">Keep your community safe and healthy</p>
		</div>
		...
		<div class="grid grid-cols-1 gap-8 md:grid-cols-3">
			...
			<div class="rounded-xl border border-border bg-card p-8">
				...
				<h3 class="font-heading mb-3 text-xl font-semibold text-card-foreground">Report System</h3>
				<p class="leading-relaxed text-muted-foreground">
...
<section class="bg-muted/30 py-20">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		<div class="mb-16 text-center">
			...
			<p class="text-xl text-muted-foreground">Make Foreum work exactly how you need it</p>
		</div>

		<div class="grid grid-cols-1 gap-8 md:grid-cols-2">
			<div class="rounded-xl border border-border bg-card p-8">
				<h3 class="font-heading mb-4 text-2xl font-semibold text-card-foreground">
					Easy Integration
				</h3>
				...
				<div class="rounded-lg bg-muted p-4 font-mono text-sm text-muted-foreground">
					&lt;script src="foreum.js"&gt;&lt;/script&gt;
				</div>
			</div>

			<div class="rounded-xl border border-border bg-card p-8">
				<h3 class="font-heading mb-4 text-2xl font-semibold text-card-foreground">Custom Themes</h3>
				<p class="mb-6 leading-relaxed text-muted-foreground">
					Match your brand perfectly with custom CSS, color schemes, and layout options. Full design
					control.
				</p>
				<div class="flex gap-2">
					<div class="h-12 w-12 rounded-lg bg-primary"></div>
					<div class="h-12 w-12 rounded-lg bg-secondary"></div>
					<div class="h-12 w-12 rounded-lg bg-accent"></div>
			...
			<div class="rounded-xl border border-border bg-card p-8">
				<h3 class="font-heading mb-4 text-2xl font-semibold text-card-foreground">API Access</h3>
				<p class="leading-relaxed text-muted-foreground">
