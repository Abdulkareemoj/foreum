<svelte:head>
	<title>Privacy Policy - Foreum</title>
...
<div class="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
	...
	<div class="prose prose-lg max-w-none">
		<div class="space-y-8 leading-relaxed text-muted-foreground">
			<section>
				<h2 class="font-heading mb-4 text-2xl font-semibold text-foreground">1. Introduction</h2>
				<p>
			...
			<section>
				<h2 class="font-heading mb-4 text-2xl font-semibold text-foreground">
					2. Information We Collect
				</h2>

				<h3 class="font-heading mt-6 mb-3 text-xl font-semibold text-foreground">
			...
			<section>
				<h2 class="font-heading mb-4 text-2xl font-semibold text-foreground">5. Data Security</h2>
				<p>
			...
			<section>
				<h2 class="font-heading mb-4 text-2xl font-semibold text-foreground">6. Data Retention</h2>
				<p>
			...
			<section>
				<h2 class="font-heading mb-4 text-2xl font-semibold text-foreground">7. Your Rights</h2>
				...
				<p class="mt-4">To exercise these rights, please contact us at privacy@foreum.com.</p>
			</section>

			<section>
				<h2 class="font-heading mb-4 text-2xl font-semibold text-foreground">8. Cookies</h2>
				<p>
					...
					See our <a href="/cookies" class="text-primary hover:underline">Cookie Policy</a> for more
					information.
				</p>
			</section>
			...
			<section>
				<h2 class="font-heading mb-4 text-2xl font-semibold text-foreground">12. Contact Us</h2>
