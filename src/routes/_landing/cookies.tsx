...
export const Route = createFileRoute('/_landing/cookies')({
  head: () => ({
    meta: [...seo({ title: 'Cookies Policy - Foreum', description: 'Cookies Policy for Foreum.' })],
  }),
 ...
 function CookiesPage(){
    return (
				...
				<h1 className="font-heading mb-4 text-4xl font-bold text-foreground">Cookie Policy</h1>
			...
			<section>
				...
				<p>
					...
					account settings. Note that disabling certain cookies may affect the functionality of the
					Service.
				</p>
				...
				<ul className="flex flex-col gap-2 list-disc pl-6">
					<li>
						<a
							...
							target='_blank'
							rel="noopener">Google Analytics Opt-out</a>
					</li>
					<li>
						<a
							...
							className="text-primary hover:underline"
							target='_blank'
							rel="noopener">Digital Advertising Alliance Opt-out</a>
					</li>
					<li>
						<a
							...
							className="text-primary hover:underline"
							target='_blank'
							rel="noopener">Network Advertising Initiative Opt-out</a>
					</li>
				</ul>
			</section>
			...
			<section>
				...
				<p>
					...
					for legal reasons. We will notify you of any material changes by posting the new policy on
					this page.
				</p>
			</section>
