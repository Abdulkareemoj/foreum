...
export const Route = createFileRoute('/_moderator/moderation')({
  head: () => ({
    meta: [...seo({ title: 'Moderation Queue - Foreum' })],
  }),
  component: ModeratorModeration,
})
    ...
    <div className="flex flex-col gap-6 p-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Track moderation activity and review recent actions taken by your team.
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <History className="size-5" /> Recent Activity
          </CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
